...
//     price: "LKR 10,000",
//     description: "A boucle upholstered accent chair with natural wooden legs and a modern silhouette.",
...
//     name: "Boucle Dining Armchair",
//     price: "LKR 8,500",
//     description: "Soft boucle upholstery and slim oak legs for a refined, cozy dining look.",
//     badge: "25% Off",
...
//     price: "LKR 12,900",
//     description: "Gently curved frame with generous cushioning, perfect for reading corners.",
//     image: "/products/ch1.png",
//   },
//   {
//     id: 4,
...
//     price: "LKR 9,700",
//     description: "Clean lines and soft padding for modern living rooms and studios.",
//     image: "/products/ch2.png",
//   },
//   {
//     id: 5,
...
//     price: "LKR 11,200",
//     description: "Scandinavian-inspired design with warm wood tones and textured fabric.",
//     image: "/products/ch1.png",
//   },
// ]
...
//     <section
//       ref={sectionRef}
//       className="relative overflow-hidden py-12 sm:py-20 md:py-32 lg:py-36 px-4 sm:px-6 md:px-8 lg:px-10"
//     >
//       <div
...
//             From living spaces to workspaces, discover furniture crafted with intention, refined craftsmanship, and a
//             focus on comfort, durability, and timeless design.
//           </p>
...
//           <div
//             className={`
//               w-full lg:basis-[55%] pt-10 sm:pt-0
//               transition-all duration-700
//               ${inView ? "opacity-100 -translate-x-0" : "opacity-0 -translate-x-6"}
//             `}
//           >
//             <div className="relative w-full rounded-2xl sm:rounded-3xl lg:rounded-[40px] bg-[#E9EDF2] shadow-[0_28px_80px_rgba(0,0,0,0.18)] px-4 sm:px-6 md:px-8 lg:px-12 pt-6 sm:pt-8 pb-4 sm:pb-6 lg:pb-8 overflow-visible">
//               {/* chair image */}
//               <div className="absolute left-2 sm:left-4 md:left-6 -top-16 sm:-top-20 md:-top-33 lg:-top-28">
//                 <Image
...
//                 </p>
//                 {bigCard.badge && (
//                   <p className="mt-0 text-xs sm:text-sm md:text-base font-semibold text-(--color-topic)">
//                     {bigCard.badge}
//                   </p>
//                 )}
//               </div>
...
//           >
//             {/* Desktop heading */}
//             <div className="pb-8 md:pb-16 lg:pb-24 hidden md:block">
...
//                 From living spaces to workspaces, discover furniture crafted with intention, refined craftsmanship, and
//                 a focus on comfort, durability, and timeless design.
//               </p>
...
//               className={`
//                 relative
//                 transition-all duration-700 delay-300 pt-10 sm:0
//                 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}
//               `}
//             >
//               <div className="relative w-full rounded-2xl sm:rounded-3xl lg:rounded-[40px] bg-(--color-card-background) shadow-[0_24px_70px_rgba(0,0,0,0.18)] px-4 sm:px-6 md:px-8 lg:px-12 pt-6 sm:pt-8 pb-4 sm:pb-6 lg:pb-8 overflow-visible">
