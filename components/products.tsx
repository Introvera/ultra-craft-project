      ...
      >
        ...
        <div className="flex w-full flex-col gap-8 sm:gap-12 md:gap-16 lg:flex-row lg:items-start">
          ...
          >
            ...
            {/* small card */}
            <div className="relative pt-0 sm:visible hidden">
              <AnimatePresence mode="wait" custom={direction}>
                <motion.div
                  key={smallCard.id}
                  custom={direction}
...
//         {/* MOBILE heading */}
//         <div className="pb-12 sm:pb-20 md:hidden">
//           <h1 className="mb-3 text-2xl font-semibold text-[var(--color-topic)]">
//             Refined Modern Furniture
//           </h1>
//           <p className="text-sm leading-relaxed text-black text-justify max-w-xl">
//             From living spaces to workspaces, discover furniture crafted with
//             intention, refined craftsmanship, and a focus on comfort,
//             durability, and timeless design.
//           </p>
...
//           {/* BIG CARD */}
//           <div
//             className={`w-full md:basis-[55%] mt-10 md:mt-0 transition-all duration-700 ${
//               inView ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-6"
//             }`}
//           >
//             <AnimatePresence mode="wait" custom={direction}>
...
//                 exit="exit"
//                 transition={{ duration: 0.35, ease: "easeOut" }}
//                 className="relative w-full rounded-2xl bg-[#E9EDF2] shadow-[0_28px_80px_rgba(0,0,0,0.18)] px-4 pt-6 pb-4 sm:px-6 sm:pt-14 md:px-8 lg:px-12 overflow-visible"
//               >
//                 {/* IMAGE */}
//                 <div className="absolute left-2 sm:left-4 md:left-6 -top-16 sm:-top-20 md:-top-24 lg:-top-28">
//                   <Image
...
//                 {/* PRICE */}
//                 <div className="absolute top-3 right-4 sm:top-4 sm:right-6 md:top-6 md:right-8 lg:right-12 text-right">
//                   <p className="text-lg sm:text-2xl md:text-3xl font-semibold">
//                     {bigCard.price}
//                   </p>
//                   {bigCard.badge && (
//                     <p className="mt-0 text-xs sm:text-sm font-semibold text-[var(--color-topic)]">
//                       {bigCard.badge}
//                     </p>
//                   )}
//                 </div>
...
//                 {/* TEXT */}
//                 <div className="flex flex-col justify-end pt-28 md:pt-44 lg:pt-64 pb-2">
//                   <h3 className="text-base sm:text-lg lg:text-xl font-semibold truncate">
//                     {bigCard.name}
//                   </h3>
//                   <p className="mt-2 text-xs sm:text-sm lg:text-base text-neutral-700 leading-relaxed line-clamp-2">
//                     {bigCard.description}
//                   </p>
//                 </div>
//               </motion.div>
...
//           <div
//             className={`hidden md:flex flex-col gap-8 md:basis-[45%] transition-all duration-700 ${
//               inView ? "opacity-100 translate-x-0" : "opacity-0 translate-x-6"
//             }`}
//           >
//             {/* SMALL CARD */}
...
//                 exit="exit"
//                 transition={{ duration: 0.35, ease: "easeOut" }}
//                 className="relative w-full rounded-3xl bg-[var(--color-card-background)] shadow-[0_24px_70px_rgba(0,0,0,0.18)] px-8 pt-10 pb-6 overflow-visible"
//               >
...
//                   <p className="text-xl font-semibold">{smallCard.price}</p>
//                   {smallCard.badge && (
//                     <p className="text-sm font-semibold text-[var(--color-topic)]">
//                       {smallCard.badge}
//                     </p>
//                   )}
//                 </div>
