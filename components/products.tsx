...
//   return (
//     <section className="relative overflow-hidden sm:py-36 pb-36 px-4 sm:px-6 md:px-10">
...
//                 </p>
//                 {bigCard.badge && (
//                   <p className="mt-0 text-md font-semibold text-[var(--color-topic)]">
//                     {bigCard.badge}
//                   </p>
//                 )}
//               </div>
...
//           <div className="w-full md:basis-[45%] flex flex-col gap-8 md:mt-[-100px]">
//             {/* Desktop heading */}
...
//               <div className="relative w-full max-w-md h-full rounded-[40px] bg-[#F5E3D8] shadow-[0_24px_70px_rgba(0,0,0,0.18)] px-8 pt-10 pb-8 overflow-visible">
