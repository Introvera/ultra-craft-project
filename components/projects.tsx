...
//     <section
//       ref={sectionRef}
//       className="relative overflow-hidden w-full py-12 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 md:px-8 lg:px-10"
//     >
//       <div
...
//             <Button variant="primary" size="pill" className="text-black">
//               Request Consultation
//               <ArrowUpRight className="ml-2 size-4 sm:size-5" />
//             </Button>
//             <Button className="bg-black text-white" size="pill">
//               View All Projects
//               <ArrowUpRight className="ml-2 size-4 sm:size-5" />
//             </Button>
//           </div>
...
//           {/* Mobile buttons under card (unchanged layout) */}
//           <div className="mt-4 flex w-full max-w-sm flex-wrap gap-3">
//             <Button
//               variant="primary"
//               size="pill"
