...
const philosophyItems: PhilosophyItem[] = [
  {
    ...
    image: "/aboutus-page/philosophy1.webp",
    variant: "dark",
    imageAlign: "center",
  ...
  },
  {
    ...
    image: "/aboutus-page/philosophy3.webp",
    variant: "dark",
    imageAlign: "center",
...
function PhilosophyCard({ item }: { item: PhilosophyItem }) {
  ...
  return (
    <div
      className={`relative rounded-3xl sm:rounded-[32px] px-5 sm:px-6 md:px-7 lg:px-8 ${
        item.cardPaddingTopClass
      } pb-6 sm:pb-7 md:pb-8 overflow-visible shadow-[0_26px_70px_rgba(0,0,0,0.25)] min-h-[260px] md:min-h-[320px] lg:min-h-[360px] ${
        isDark
